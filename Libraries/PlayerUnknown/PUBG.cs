namespace PlayerUnknown
{
    ...
    public static class PUBG
    {
        ...
        public static Process AttachedProcess
        {
            get
            {
                if (PUBG._AttachedProcess != null)
                {
                    ...
                    PUBG._AttachedProcessFactory = null;
                }
        ...
        /// <summary>
        /// Gets the attached <see cref="PUBG"/> process factory.
        /// </summary>
        public static ProcessSharp AttachedProcessFactory
        {
            get
            {
                if (PUBG._AttachedProcess != null)
                {
                    if (PUBG._AttachedProcess.HasExited == false)
                    {
                        if (PUBG._AttachedProcessFactory != null)
                        {
                            return PUBG._AttachedProcessFactory;
                        }
                    }
        ...
        private static ProcessSharp _AttachedProcessFactory;
        ...
        public static void Attach(bool BattlEyeProtected = true)
        {
            ...
            if (Processus != null)
            {
                ...
                PUBG._AttachedProcessFactory = new ProcessSharp(Processus, MemoryType.Remote);
            }
        }
