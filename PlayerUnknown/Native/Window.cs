namespace PlayerUnknown.Native
{
    ...
    using Rectangle = global::PlayerUnknown.Native.Structures.Rectangle;
    ...
    public static class Window
    {
        ...
        {
            var Rectangle = Window.GetWindowRectangle(Handle);
        ...
        public static Bitmap GetGamePixels(IntPtr Handle, bool RemoveBorders = true)
        {
            ...
            var Game    = Window.GetWindowRectangle(Handle, RemoveBorders);
